# Manual Operacional — AI Orchestrator Suite v3
...
2. Rode `./ai_orchestrator_suite_v3/devops/ai.sh init` (ou `.\ai.ps1 init`).
...
./ai_orchestrator_suite_v3/devops/ai.sh run backend tasks/BUG-201.md --engine=claude --decision=AUTOMÁTICO
```
